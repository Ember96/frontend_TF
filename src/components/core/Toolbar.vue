  ...
  <v-toolbar
    ...
    <v-dialog
      ...
      <v-card>
        ...
        <v-card-text>
          Queda terminantemente prohibido el uso de lenguaje soez o que promueva un discurso de odio. El objetivo de este sitio es mejorar el bienestar ciudadano, cualquier publicación que se aleje de este objetivo será eliminada por los moderadores.
        </v-card-text>
...
export default {
  data() {
    return {
      ...
      languages: [
        { name: 'Español', languageCode: 'es', path: require('../../assets/flags/es.png') },
